...
Ansys workbench start the external CAD software, an "Ansys Link" menu appeared in CAD software.  After finish modeling in CAD software and close/jump to Ansys workbench. The geometry and named enetities are ready to use. I believe IGES/STEP is used to transfer model.
...
If embed attribute into STEP is hard, a bundle of XML + STEP could be used. see freecad.org/forum discussion of [Managing shapes names with STEP import/export](http://forum.freecadweb.org/viewtopic.php?t=3972)
