...
From the author's point of view, it is recommended to use compatiable layer such as  "Qt.py" (single python file) or "qtpy" (PyPI package) to suport various bindings:  "PyQt4, PyQt5, PySide and PySide2". Pyside2 is the preferred binding for LGPL license and it is under heavy developme as an official module for Qt.
