...
This section is excerpt form [*Sri Sanketh Uppalapati* article on GeeksforGeeks](https://www.geeksforgeeks.org/reloading-modules-python/)
...
# more code copied from interpretor widget, whatever recorded by macro recording
