...
The geometry algorithm using OpenCASCADE will be discussed in Chapter 7.
...
- OpenCASCADE(OCC) and VTK is migrating to 7.0 in late 2016, that is significant upgrade breaking back imcompatibility.
